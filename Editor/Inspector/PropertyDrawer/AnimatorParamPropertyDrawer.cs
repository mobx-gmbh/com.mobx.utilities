...
namespace MobX.Utilities.Editor.Inspector.PropertyDrawer
{
    ...
    public class AnimatorParamPropertyDrawer : UnityEditor.PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(UnityEditor.SerializedProperty property, GUIContent label)
        {
            ...
            var validPropertyType = property.propertyType == UnityEditor.SerializedPropertyType.Integer || property.propertyType == UnityEditor.SerializedPropertyType.String;
        ...
        public override void OnGUI(Rect rect, UnityEditor.SerializedProperty property, GUIContent label)
        {
            ...
            UnityEditor.Animations.AnimatorController animatorController = GetAnimatorController(property, animatorParamAttribute.AnimatorName);
            if (animatorController == null)
            {
                UnityEditor.EditorGUILayout.HelpBox(InvalidAnimatorControllerWarningMessage, UnityEditor.MessageType.Warning);
                return;
            }
            ...
            for (var i = 0; i < parametersCount; i++)
            {
                ...
                if (animatorParamAttribute.ParameterType == null || parameter.type == animatorParamAttribute.ParameterType)
                {
            ...
            switch (property.propertyType)
            {
                ...
                case UnityEditor.SerializedPropertyType.String:
                    ...
                    break;
                default:
                    UnityEditor.EditorGUILayout.HelpBox(string.Format(InvalidTypeWarningMessage, property.name), UnityEditor.MessageType.Warning);
                    break;
            }
        ...
        private static void DrawPropertyForInt(Rect rect, UnityEditor.SerializedProperty property, GUIContent label, List<AnimatorControllerParameter> animatorParameters)
        {
        ...
        private static void DrawPropertyForString(Rect rect, UnityEditor.SerializedProperty property, GUIContent label, List<AnimatorControllerParameter> animatorParameters)
        {
        ...
        private static UnityEditor.Animations.AnimatorController GetAnimatorController(UnityEditor.SerializedProperty property, string animatorName)
        {
            var target = PropertyUtility.GetTargetObjectWithProperty(property);
            Type targetType = target.GetType();
            FieldInfo animatorFieldInfo = targetType.GetFieldIncludeBaseTypes(animatorName);
            ...
            PropertyInfo animatorPropertyInfo = targetType.GetPropertyIncludeBaseTypes(animatorName);
            ...
            MethodInfo animatorGetterMethodInfo = targetType.GetMethodIncludeBaseTypes(animatorName);
        ...
        private static class PropertyUtility
        {
            ...
            {
                Type targetType = GetTargetObjectWithProperty(property).GetType();
                FieldInfo fieldInfo = targetType.GetFieldIncludeBaseTypes(property.name);
                if (fieldInfo == null)
                {
                    return new T[]
                    {
